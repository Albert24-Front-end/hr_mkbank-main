...
const filteredVacancies = computed(() => {
  ...
  return vacancies ? vacancies.value.filter(v => {
    ...
    const searchMatch = !confirmedSearch.value || v.heading.toLowerCase().includes(searchField.value.toLowerCase())

    return locationMatch && directionMatch && searchMatch
  }) : []
})
