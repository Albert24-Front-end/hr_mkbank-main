      ...
      <div class="mt-10 grid grid-cols-1 lg:grid-cols-6 gap-12">
        <div class="lg:col-span-2">
          <form @submit.prevent="submitForm" class="w-full flex flex-col px-5 py-5 space-y-4 bg-white shadow-lg rounded-xl">
            ...
            <button
              type="submit"
              class="py-2 px-4 text-sm text-white bg-primary rounded-lg hover:cursor-pointer hover:bg-primary/50 disabled:cursor-not-allowed aria-disabled:cursor-not-allowed disabled:opacity-75"
              id="filter"
            >
