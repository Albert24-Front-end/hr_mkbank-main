...
const rules = computed(() => ({
  ...
  phoneField: {required: helpers.withMessage('Номер телефона обязателен', required), minLength: helpers.withMessage('Введите номер правильно', minLength(19))},
  emailField: {
...
const submitForm = async()=> {
  ...
  if(result) {
    ...
    alert('Your CV has been successefully sent to our HR department!')
  } else {
        ...
        <div class="lg:col-span-2">
          <form @submit.prevent="submitForm" class="w-full flex flex-col px-5 py-5 space-y-4 bg-white shadow-lg rounded-xl">
            ...
            <div class="py-5 flex flex-col gap-4 text-sm">
              ...
              <div v-if="v.surnameField.$error" class="text-red-500 text-sm mt-1">
              ...
              <div v-if="v.nameField.$error" class="text-red-500 text-sm mt-1">
              ...
              <div v-if="v.emailField.$error" class="text-red-500 text-sm mt-1">
              ...
              <div v-if="v.phoneField.$error" class="text-red-500 text-sm mt-1">
              ...
              <div class="flex flex-col gap-2">
                ...
                >
                  <span class="block text-center max-w-full truncate px-2">{{formData.fileField?.name || $t('vacancy_response_form.file_input') }}</span>
                  <input
                    type="file"
                    accept=".pdf, .docx"
              ...
              <div v-if="v.fileField.$error" class="text-red-500 text-sm mt-1">
