...
const rules = computed(() => ({
  emailField: {
    ...
    required:helpers.withMessage('Электронная почта обязательна', ema)
  },
}))
        ...
        <div class="lg:col-span-2">
          <form class="w-full flex flex-col px-5 py-5 space-y-4 bg-white shadow-lg rounded-xl">
            ...
            <div class="py-5 flex flex-col gap-4 text-sm">
              ...
              <div v-if="v.emailField.$dirty && v.emailField.$errors.length > 0" class="text-red-500 text-sm mt-1">
