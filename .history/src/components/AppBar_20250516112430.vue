  ...
  >
    ...
    <div class="desktop-menu hidden md:flex">
      ...
      >
        ...
        <li class="py-1 px-2 hover:cursor-pointer hover:bg-sky-100 rounded-lg">
          <a href="">{{ t('buttons.career') }}</a>
        </li>
        <li class="py-1 px-2 hover:cursor-pointer hover:bg-sky-100 rounded-lg">
          <a href="">{{ t('buttons.vacancies') }}</a>
        </li>
        <li class="py-1 px-2 hover:cursor-pointer hover:bg-sky-100 rounded-lg">
          <a href="">{{ t('buttons.contacts') }}</a>
        </li>
        <li class="hover:cursor-pointer hover:bg-sky-100 rounded-lg"><LanguageSwitcher v-model="$i18n.locale"/></li>
      </ul>
    </div>
