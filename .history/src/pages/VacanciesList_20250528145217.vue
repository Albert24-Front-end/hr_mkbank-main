...
const filterVacancies = computed(() => {
  return vacancies ? vacancies.value.filter(v => {
    const locationMatch = v.location === selectedLocation.value
    const directionMatch = v.direction === selectedDirection.value
    ...
    <div class="@container mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="mt-10 grid grid-cols-1 lg:grid-cols-8 gap-6">
        ...
        <div class="lg:col-span-6 w-full space-y-4">
          <VacancyCard v-for="v in filterVacancies" :key="v.id"
            :heading="v.heading"
            :city="v.location"
            :region="v.region"
