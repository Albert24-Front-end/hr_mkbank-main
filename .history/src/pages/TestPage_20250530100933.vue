...
const products = [
    {title: "Oranges", price: "10", weight: 1},
    {title: "Apples", price: "4", weight: 2},
    {title: "Pears", price: "6", weight: 1.5},
    {title: "Bananas", price: "9", weight: 0.5},
    {title: "Peaches", price: "8", weight: 0.8},
...
<template>
  <section class="w-full py-20 bg-gray-50" id="vacancies-list">
    <div class="@container mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <ul v-for="product in queryItems" :key="">
        <li>{{ product }}</li>
      </ul>
    </div>
  </section>
