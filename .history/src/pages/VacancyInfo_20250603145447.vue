...
const rules = computed(() => ({
  ...
  phoneField: {required: helpers.withMessage('Номер телефона обязателен', required)},
  emailField: {
...
const showemailFieldError = computed(() =>
  v.value.emailField.$dirty && v.value.emailField.$invalid,
  v.value.nameField.$dirty && v.value.nameField.$invalid,
  v.value.surnameField.$dirty && v.value.surnameField.$invalid,
  v.value.phoneField.$dirty && v.value.phoneField.$invalid
      ...
      <div class="mt-10 grid grid-cols-1 lg:grid-cols-6 gap-12">
        <div class="lg:col-span-2">
          <form @submit.prevent="submitForm" class="w-full flex flex-col px-5 py-5 space-y-4 bg-white shadow-lg rounded-xl">
            ...
            <div class="py-5 flex flex-col gap-5 text-sm">
              ...
              <div v-if="showemailFieldError" class="text-red-500 text-sm mt-1">
